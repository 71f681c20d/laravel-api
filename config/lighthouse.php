...
return [
    ...
    */
    ...
    'namespaces' => [
        ...
        'middleware' => ['auth:api'], // Middleware applied to all schemas
        'resolvers' => [
            'Query' => [
                'users' => 'App\\GraphQL\\Resolvers\\UserResolver@users',
            ],
            'Mutation' => [
                'createUser' => 'App\\GraphQL\\Resolvers\\UserResolver@createUser',
            ],
        ],
    ],
